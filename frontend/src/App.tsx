...
import StudentSubmissionsList from "./pages/StudentSubmissionsList";
          ...
          <header className="no-print border-b border-slate-900 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                {isSuperadmin ? (
                  <span className="px-2.5 py-1 rounded-full bg-amber-950 border border-amber-800 text-amber-400 text-xs font-semibold">
                    Leitura &amp; backup
                  </span>
                ) : (
                  <UserNav />
