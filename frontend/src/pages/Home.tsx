...
import { GraduationCap, Trophy, ShieldAlert, Key, ClipboardList } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col justify-center max-w-lg mx-auto w-full py-6">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 text-sm">
          Sem cadastros complicados. Digite seu código de prova ou gerencie seus gabaritos de forma 100% digital.
        </p>
      </div>
      ...
      {role === null && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="font-bold text-lg mb-1 group-hover:text-cyan-400 transition-colors">Sou Aluno</h3>
            <p className="text-xs text-slate-500 max-w-[180px]">Responder gabarito e consultar notas de provas finalizadas.</p>
          </button>
          ...
          >
            ...
            <h3 className="font-bold text-lg mb-1 group-hover:text-blue-400 transition-colors">Sou Professor</h3>
            <p className="text-xs text-slate-500 max-w-[180px]">Criar gabaritos oficiais, emitir QR codes e monitorar notas.</p>
          </button>
        </div>
      )}
        ...
        <div className="glass-panel border border-slate-800 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Insira o código fornecido pelo professor</p>
            </div>
          </div>

          <form onSubmit={handleStudentAccess} className="space-y-4">
            <div>
              <label htmlFor="publicCode" className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider">
        ...
        <div className="space-y-6">
          <div className="glass-panel border border-slate-800 rounded-2xl p-6 relative overflow-hidden">
            ...
            <div className="text-center mb-6">
              <h2 className="font-extrabold text-xl mb-1">Área Administrativa</h2>
              <p className="text-xs text-slate-500">Crie novos gabaritos ou monitore as provas ativas.</p>
            </div>
            ...
            <div className="relative flex py-3 items-center">
              ...
              <span className="flex-shrink mx-4 text-slate-600 text-[10px] uppercase font-bold tracking-widest">Ou acesse uma prova existente</span>
              <div className="flex-grow border-t border-slate-900"></div>
            </div>

            <form onSubmit={handleTeacherAccess} className="space-y-4 mt-4">
              <div>
                <label htmlFor="adminToken" className="block text-xs font-semibold text-slate-400 mb-1.5 uppercase tracking-wider">
